...
class AppDelegate: UIResponder, UIApplicationDelegate {
 ...
 /*   func update() {
        ...
        do{
            ...
            if(change != String(amount2) && change != nil)
            {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.example.CheckStudbo" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("CheckStudbo", withExtension: "momd")!
